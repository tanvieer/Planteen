...
<div class="col-md-12 mb-4">
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="nav-item"><a class="nav-link" data-toggle="tab"
			href="#Past_order" role="tab" aria-controls="Orders"
			aria-expanded="true">Past Orders</a></li>
		<li class="nav-item"><a class="nav-link" data-toggle="tab"
			href="#Current_order" role="tab" aria-controls="Orders"
			aria-expanded="false">Current Orders</a></li>
		<li class="nav-item"><a class="nav-link active" data-toggle="tab"
			href="#test-table" role="tab" aria-controls="TestTable"
			aria-expanded="false">Test table</a></li>
...
<!-- 			Past Order end -->
		...
		<div class="tab-pane active" id="test-table" role="tabpanel"
			aria-expanded="true">
